...
void setTitle(QWidget *w, QString s)
{
    ...
    else w->setWindowTitle(QString("LibreClubBridge %1.%2.%3").arg(VERSION_MAJOR).arg(VERSION_MINOR).arg(VERSION_BUILD));
}
...
void setBidHistoryText(QLabel *l, Bid bid)
{
    ...
    int id = QFontDatabase::addApplicationFont("/home/joe/Qt/Projects/LibreBridge/fonts/SourceCodePro-Regular.ttf");
	if(id >= 0)
	{
